...
#  todo 所有家族指定月份中most top优化师和other投放的广告数据 - 字段说明
...
alltopopts_ads_df = pd.concat(alltopopts_ads)  # ============================ tops
...
allotheropts_ads_df = pd.concat(allotheropts_ads)  # =========================================== others
...
# todo 把广告组和广告系列关联起来；进而按照系列和优化师进行划分

...
def readdatafromdatabase():
    ...
    roi
    from gk_product_report where platform='facebook' and invalid=0;"""  # to giikin giikin_aliyun.tb_rp_pro_sale_report_di
...
# wait 这里的产品数据是只有投放在FB的产品: 接下来做的是把好的优化师投放的商品从下面的数据中选择出来；
# with open('gk_product_report_fb.pick', 'rb') as f:
with open(r'F:\Documents\Stage-work-arrangement\nowaddata\read_gdsc_gk_product_report\gk_product_report_fb.pick', 'rb') as f:

...
"""
@Author:UmeAI
@File:concat_campaign_and_cam_report_and_ad_groups.py
...
# 读取的是商品广告系列数据信息
with open('./read_apionline_gk_campaign_and_camreport/giikinadcampaign.pick', 'rb') as f:
...
# 读取的是基于商品广告系列的统计信息
with open('./read_apionline_gk_campaign_and_camreport/giikinadcampaign_report.pick', 'rb') as f:
...
# 读取广告组的信息
with open('./read_ad_groups/adgroup.pick', 'rb') as f:
    giikinad_groups = pickle.load(f)

# wait  对广告campaign的report按照id做汇总
...
# wait  优化师投放出来的广告和广告的report数据信息的关联

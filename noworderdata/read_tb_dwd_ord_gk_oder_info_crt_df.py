...
@todo: 读取订单表信息tb_dwd_ord_gk_oder_info_crt_df；这个业务出现的原因在于处理线路上的所有信息以更好的做推荐工作；
@fixme: 
@important:
...
sql = """ select
    ...
    from giikin_aliyun.tb_dwd_ord_gk_order_info_crt_df where pt={} -- and befrom = 'facebook';
""".format(orders_data)
